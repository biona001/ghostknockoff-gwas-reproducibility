...
Zscores<-as.data.frame(fread('/oak/stanford/groups/zihuai/ESGWAS_lasso/Z_scores/AD_meta/AD_Zscores_Meta_Zhaomeng.txt'))
Zscores<-Zscores[,-ncol(Zscores)]
colnames(Zscores)[ncol(Zscores)]<-'Z'
...
temp.filename<-paste0(out.dir,'results_AD_Meta_All_Zhaomeng_',replicate,'.txt')
