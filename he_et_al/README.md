...
```shell
$ Rscript --vanilla GKL_RunAnalysis_All.R \
    11 \
    /scratch/users/bbchu/ghostknockoff-gwas-reproducibility/data/EUR \
    /scratch/users/bbchu/ghostknockoff-gwas-reproducibility/data/AD_Zscores_Meta.txt \
    /scratch/users/bbchu/ghostknockoff-gwas-reproducibility/data/SummaryStatInfo.txt \
    /scratch/users/bbchu/ghostknockoff-gwas-reproducibility/data/topcS2GGene_allVariants.csv \
    /scratch/users/bbchu/ghostknockoff-gwas-reproducibility/Results
```
